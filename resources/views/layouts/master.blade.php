...
<body class="vertical-layout vertical-menu-modern  navbar-floating footer-static   menu-collapsed" data-open="click"
        ...
        <div class="navbar-container d-flex content">
            ...
            <ul class="nav navbar-nav align-items-center ms-auto">
                ...
                <li class="nav-item dropdown dropdown-user"><a class="nav-link dropdown-toggle dropdown-user-link"
                        ...
                        aria-expanded="false">
                        <div class="user-nav d-sm-flex d-none"> @yield('content')</div><span class="avatar"><img
            ...
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                <li class=" nav-item"><a class="d-flex align-items-center" href="index.html"><i
                    ...
                    {{-- <ul class="menu-content">
                        <li><a class="d-flex align-items-center" href="{{ route('route-addnew') }}"><i data-feather="circle"></i><span class="menu-item text-truncate" data-i18n="Analytics">Add new</span></a>
                        </li>
                        <li><a class="d-flex align-items-center" href="{{ route('route-viewall') }}"><i data-feather="circle"></i><span class="menu-item text-truncate" data-i18n="eCommerce">View all</span></a>
                       
                    </ul> --}}
                </li>
                <li class=" nav-item"><a class="d-flex align-items-center" href="index.html">
                        <i data-feather="menu"></i>
                        <span class="menu-title text-truncate" data-i18n="Dashboards">Inquriy Mangement</span>
                    </a>

                    <ul class="menu-content">
                        <li><a class="d-flex align-items-center" href="{{ route('route-addnew') }}"><i
                                    data-feather="circle"></i><span class="menu-item text-truncate"
                                    data-i18n="Analytics">Add new Inquiry</span></a>
                        </li>
                        <li><a class="d-flex align-items-center" href="{{ route('route-viewall') }}"><i
                                    data-feather="circle"></i><span class="menu-item text-truncate"
                                    data-i18n="eCommerce">View all Inquiry</span></a>
    ...
    <span class="menu-title text-truncate" data-i18n="Dashboards"> Salary Management</span>
                    ...
                    <ul class="menu-content">
                        <li><a class="d-flex align-items-center" href="{{ route('route-addnewsalary') }}"><i
                                    data-feather="circle"></i><span class="menu-item text-truncate"
                                    data-i18n="Analytics">Add new salary</span></a>
                        </li>
                        <li><a class="d-flex align-items-center" href="{{ route('route-viewallsalary') }}"><i
                                    data-feather="circle"></i><span class="menu-item text-truncate"
                                    data-i18n="eCommerce">View all salary</span></a>
